 ...
 * @author ASUS
 */
public class Signup_Teacher_pirghachaController implements Initializable {
    ...
    private void submit(ActionEvent event) throws SQLException {
       ...
       String queary = "insert into pirgacha values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject()+ "','" + obj.getEducation()+ "','" + obj.getSalary() + "')";
