 ...
 * @author ASUS
 */
public class Signup_Teacher_badargangController implements Initializable {
    ...
    private void submit(ActionEvent event) throws SQLException {
        ...
        String queary = "insert into badargong values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject()+ "','" + obj.getEducation()+ "','" + obj.getSalary() + "')";
