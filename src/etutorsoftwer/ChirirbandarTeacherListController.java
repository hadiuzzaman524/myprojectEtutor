 ...
 * @author ASUS
 */
public class ChirirbandarTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
          All_Teacher_Information_DinajpurDatabase obj = new All_Teacher_Information_DinajpurDatabase();
        String queary = "select *from chirirbandar";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
         FindTeacher_Dinajpur_DistrictController.chirirbandar.close();
    }
