 ...
 * @author ASUS
 */
public class All_Teacher_Information_DinajpurDatabase {
          
   Connection getConnection() throws SQLException
    {  
        Connection conn=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/dinajpurdistrict", "root", "");
