 ...
 * @author ASUS
 */
public class Signup_Teacher_kaharolController implements Initializable {
    ...
    private void submit(ActionEvent event) {
        ...
        String queary = "insert into kaharol values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject() + "','" + obj.getEducation() + "','" + obj.getSalary() + "')";
        ...
        if (!nam.equals("") && !add.equals("") && !emai.equals("") && !mob.equals("") && !edu.equals("") && !sub.equals("") && !salar.equals("")) {
            boolean m = false;
                    try {
                        ...
                        Logger.getLogger(Signup_Teacher_kaharolController.class.getName()).log(Level.SEVERE, null, ex);
                    }
            if (m == true) {
