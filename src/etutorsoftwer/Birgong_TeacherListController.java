 ...
 * @author ASUS
 */
public class Birgong_TeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from birgong";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
         FindTeacher_Dinajpur_DistrictController.birgong.close();
    }
