 ...
 * @author ASUS
 */
public class KaharolTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from kaharol";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
         FindTeacher_Dinajpur_DistrictController.kahrol.close();
    }
