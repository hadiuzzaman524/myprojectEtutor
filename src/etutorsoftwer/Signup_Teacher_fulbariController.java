 ...
 * @author ASUS
 */
public class Signup_Teacher_fulbariController implements Initializable {
    ...
    private void submit(ActionEvent event) {
        ...
        String queary = "insert into fulbari values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject() + "','" + obj.getEducation() + "','" + obj.getSalary() + "')";
        ...
        if (!nam.equals("") && !add.equals("") && !emai.equals("") && !mob.equals("") && !edu.equals("") && !sub.equals("") && !salar.equals("")) {
            ...
            try {
                ...
                Logger.getLogger(Signup_Teacher_fulbariController.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (m == true) {
