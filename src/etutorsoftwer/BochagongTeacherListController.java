 ...
 * @author ASUS
 */
public class BochagongTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from bochagong";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
        FindTeacher_Dinajpur_DistrictController.bochagong.close();
    }
