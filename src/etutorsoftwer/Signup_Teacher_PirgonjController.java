 ...
 * @author ASUS
 */
public class Signup_Teacher_PirgonjController implements Initializable {
    ...
    private void submit(ActionEvent event) throws SQLException {
        ...
        All_Teacher_Information_DataBase teacher = new All_Teacher_Information_DataBase();
         ...
         String queary = "insert into pirgonj values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject()+ "','" + obj.getEducation()+ "','" + obj.getSalary() + "')";
