 ...
 * @author ASUS
 */
public class KhansamaTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from khanshama";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
        FindTeacher_Dinajpur_DistrictController.khansama.close();
    }
