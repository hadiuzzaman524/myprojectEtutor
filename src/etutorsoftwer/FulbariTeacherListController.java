 ...
 * @author ASUS
 */
public class FulbariTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from fulbari";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
        FindTeacher_Dinajpur_DistrictController.fulbari.close();
    }
